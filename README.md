...
Codex uses the same source skill folders through the lightweight wrapper at
`codex/plugins/cotidie`. The wrapper only links the skills that should be exposed
in Codex:

| Skill | Source | Example |
|-------|--------|---------|
| [cotidie:iteration-roadmap](plugins/cotidie/skills/iteration-roadmap) | `plugins/cotidie/skills/iteration-roadmap` | - |
| [cotidie:pr-writer](plugins/cotidie/skills/pr-writer) | `plugins/cotidie/skills/pr-writer` | - |
...
codex/
  plugins/cotidie/        # Codex plugin wrapper only; not a source tree
    .codex-plugin/
      plugin.json         # Codex plugin manifest
    skills/               # Links to shared source skills
      iteration-roadmap -> ../../../../plugins/cotidie/skills/iteration-roadmap
      pr-writer -> ../../../../plugins/cotidie/skills/pr-writer
plugins/cotidie/
  .claude-plugin/
    plugin.json           # Claude Code plugin manifest
  skills/                 # source of truth for skill content
    codex-image/
    iteration-roadmap/
    pr-writer/
```
...
reference files. `plugins/cotidie/skills` is the source of truth; platform
wrappers link to those folders instead of copying them. Bundled scripts reference their location via
`${CLAUDE_PLUGIN_ROOT}`.
